    ...
    return (
        <div className="w-screen h-screen flex flex-col">
            ...
            <Popover open={!!activeTerminal} onOpenChange={closePopover}>
                <PopoverContent className='w-96 absolute left-4 top-4 whitespace-pre bg-white shadow-md rounded-md overflow-x-hidden overflow-y-scroll border border-gray-100' align="start">
                    {activeTerminal && (
